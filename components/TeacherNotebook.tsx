  ...
  return (
    <section className="space-y-5">
      <div className="rounded-lg border border-white/10 bg-white/[0.055] p-6 shadow-glow">
        ...
        <textarea
          className="mt-4 min-h-36 w-full resize-none rounded-lg border border-white/10 bg-ink/80 p-4 text-base leading-6 text-white outline-none transition placeholder:text-slate-500 focus:border-cyan-300/60"
      ...
      <div className="rounded-lg border border-white/10 bg-white/[0.055] p-6 shadow-glow">
        ...
        <textarea
          className="mt-4 min-h-44 w-full resize-none rounded-lg border border-white/10 bg-ink/80 p-4 text-base leading-6 text-white outline-none transition placeholder:text-slate-500 focus:border-cyan-300/60"
